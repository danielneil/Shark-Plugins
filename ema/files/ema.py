...
cmd_arg_help = "This plugin checks the exponential moving average (ema) for a stock. Alerts Green (OK) if the share price is above the ema, Yellow(Warning) if its below"
